                                ...
                                <li
                                    ...
                                    <div class="d-flex align-items-center row">
                                        <div class="col-12 col-sm-5 d-flex align-items-center">
                                            <div
                                                class="btn-rounded btn-outline-success mb-0 me-3 btn-sm d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="col-12 col-sm-5 mt-2 d-flex flex-column row h-100 ms-3">
                                            <span class="text-black text-xs mt-0 col-12">Tanggal seharusnya dikembalikan
                                                :</span>
                                            <span class="text-xs col-12">{{ $item->tanggal_pengembalian }}</span>
                                        </div>
                                    </div>
                                </li>
                            @empty
